...
# Dependencies
module load BASE/1.0 glog/$GLOG_VERSION-$GLOG_REVISION protobuf/$PROTOBUF_VERSION-$PROTOBUF_REVISION GCC-Toolchain/$GCC_TOOLCHAIN_VERSION-$GCC_TOOLCHAIN_REVISION
# Our environment
